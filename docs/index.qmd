...
- Select R with `--rscript`, `--r-version`, environment variables, frontmatter `r-version`, or date-only `exclude-newer`; missing selected versions are installed on demand in the private cache.
