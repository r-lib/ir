---
title: "ir"
subtitle: "Self-describing R scripts, cached package libraries, and reproducible command-line runs."
---
...
- Run package-shipped executables from an installed package's `exec/` directory with `rx` or `ir tool run`.
